...
// navigation title
export const STORE: ResourceStr = { "id": 16777234, "type": 10003, params: [], "bundleName": "com.example.list_harmony", "moduleName": "entry" };
// offset range
...
// 数据量上限（瀑布流/加载更多用）
export const MAX_DATA_LENGTH: number = 24;
// maxLines
